...
Feature: Verificar si se logra modificar usuario buscado por el ID, pero ingresando datos vacios, en este caso el nombre de trabajo

  Background:
    * url "https://reqres.in/"

  Scenario: Modificar usuario metodo PUT pero con datos VACIOS
